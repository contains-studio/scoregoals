...
echo
echo "Away-aware pause: the recorder stops capturing when the screen locks,"
echo "the Mac sleeps, or you're idle past SCOREGOALS_AWAY_PAUSE_MIN minutes"
echo "(default 5; set 0 to disable) with no meeting detected, and resumes on"
echo "activity/unlock/wake. A live meeting keeps transcribing. Every"
echo "transition is logged as 'pause: <reason>' / 'resume: <reason>'."
