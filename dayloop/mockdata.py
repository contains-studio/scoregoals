"""dayloop.mockdata — FROZEN deterministic mock DayTimeline.
...
def mock_timeline(date: str) -> DayTimeline:
    """A realistic mock day for Michael: coding on dayloop, python docs,
    ...
    sessions = [
        ...
        Session(
            ...
            app="Code", title="cli.py — dayloop",
            project="dayloop", topic="dayloop CLI + doctor command", category="coding",
            summary="Deep work on dayloop: built argparse CLI, doctor checks, sqlite store; ran tests in integrated terminal.",
            minutes=102.0,
            text_excerpt=(
        ...
        Session(
            ...
            project="dayloop", topic="python stdlib docs", category="research",
    ...
    calendar = [
        ActivityRecord(
            ...
            app="Calendar", title="Deep work block — dayloop",
            text="Recurring focus block: no meetings, build dayloop.",
    ...
    github = [
        ActivityRecord(
            ...
            text="Commit to mgalpert/dayloop: add ActivityRecord/Session/DayTimeline/Goal/Report + JSON helpers.",
            meta={"repo": "mgalpert/dayloop", "sha": "a1b2c3d", "branch": "main", "additions": 214, "deletions": 0},
        ),
        ActivityRecord(
            source="github", kind="github",
            start=_t(date, "10:52"), end=None,
            app=None, title="feat(cli): add doctor and mock subcommands",
            text="Commit to mgalpert/dayloop: doctor probes ollama/screenpipe/tools; mock writes a deterministic timeline.",
            meta={"repo": "mgalpert/dayloop", "sha": "b2c3d4e", "branch": "main", "additions": 158, "deletions": 12},
        ),
        ActivityRecord(
            source="github", kind="github",
            start=_t(date, "11:10"), end=None,
            app=None, title="chore: scaffold module stubs + config defaults",
            text="Commit to mgalpert/dayloop: sources/aggregate/analyze/compare/feedback stubs, config.toml defaults.",
            meta={"repo": "mgalpert/dayloop", "sha": "c3d4e5f", "branch": "main", "additions": 96, "deletions": 3},
        ),
    ]
